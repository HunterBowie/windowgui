...
<<<<<<< HEAD:WindowLib/triggers/interacts/TextBox.py
...
from ...text import Text
from ...entity import Entity
>>>>>>> b27ee00ae734cc14552f5c80c4def47bfca70d74:WindowLib/triggers/interacts/textBox.py
...
class TextBox(Interact):
    ...
    "9":"(","0":")","-":"_","=":"+","`":"~",
     "/": "?", ";": ":", "\\": "\|"}
<<<<<<< HEAD:WindowLib/triggers/interacts/TextBox.py
    def __init__(self, x, y, width, height, interface, color=(255, 255, 255), font_size=30):
        super().__init__(interface)
=======
    def __init__(self, x, y, width, height, window, color=(255, 255, 255), font_size=30):
